    ...
    public class OilDeliveryController : Controller
    {
        ...
        public ActionResult Order(OrderFormModel model)
        {
            ...
            if (customerRepo.Add(customer))
            {
                ...
                var customerAddress = customer.Addresses.OrderByDescending(a => a.ID).First();
        ...
        private void SendRequestNotification( OrderFormModel model )
        {
            ...
            UtilitySmtp.SendSmtpMessage(recipients, "Oil Delivery Request", emailTemplate, false, true);
        }
